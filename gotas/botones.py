...
mainstart = InlineKeyboardMarkup([[InlineKeyboardButton("𝗚𝗮𝘁𝗲𝗿𝘄𝗮𝘆𝘀 「︎⚡️」︎",callback_data="gater"),InlineKeyboardButton("𝗧𝗼𝗼𝗹𝘀 「︎📍」︎",callback_data="tools"),],[InlineKeyboardButton("𝗣𝗲𝗿𝗳𝗶𝗹 ",callback_data="perfil"),InlineKeyboardButton("𝗕𝘂𝘆 ",callback_data="buy")],[InlineKeyboardButton("❗️𝗘𝘅𝗶𝘁❗️ ",callback_data="exit")]])
